        ...
        <div className={classes.Footer}>
            <div className={classes.Line1}>
                <ul className={classes.Menu}>
                    <li>
                        <Link href="/about">
                            {/*<a className={classes.Active}>О компании</a>*/}
                            <a >О компании</a>
                        </Link>
                    </li>
                    <li>
                    ...
                    <li>
                        <Link href="https://spb.hh.ru/employer/7172" passHref>
                            <a target="_blank" rel="noopener noreferrer"
                               href="https://spb.hh.ru/employer/7172">hh.ru</a>
                        </Link>
                    </li>
                    <li>
                        <Link href="https://www.superjob.ru/clients/lenta-200736.html" passHref>
                            <a target="_blank" rel="noopener noreferrer"
                               href="https://www.superjob.ru/clients/lenta-200736.html">SuperJob.ru</a>
                        </Link>
                    </li>
                    <li>
                        <Link href="https://zarplata.ru/companies/594077" passHref>
                            <a target="_blank" rel="noopener noreferrer"
                               href="https://zarplata.ru/companies/594077">Zarplata.ru</a>
                        </Link>
                    </li>
                    <li>
                        <Link href="https://www.avito.ru/lenta?page_from=from_items_list&iid=1775136532" passHref>
                            <a target="_blank" rel="noopener noreferrer"
                               href="https://www.avito.ru/lenta?page_from=from_items_list&iid=1775136532">Avito.ru</a>
                        </Link>
                    </li>
                </ul>
            ...
            <div className={classes.Line3}>
                ...
                <a href={'https://lenta.com'} target={'_blank'} rel="noreferrer"
                   className={classes.LentaName}>lenta.com</a>
            </div>
        </div>
    </div>
}
