...
Район Приморский</div>
        ...
        <div class="${classes.Line}"></div>
              ...
              <ul class="${classes.Vacancies}">
                  <li data-tip="sdf" class="vacancy" data-id="1"  id="placemark-balloon__profile-btn_user-id_${props.user.id}">
                  <svg width="20" height="20" viewBox="0 0 27 26" fill="none"
                                                ...
                                                </svg>Кассир-продавец</li>
                  <li class="vacancy" data-id="1"><svg width="20" height="20" viewBox="0 0 27 26" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="13.0039" cy="13" r="13" fill="#35219A"/>
                                                    <g clip-path="url(#clip0_480_457)">
                                                        <path
